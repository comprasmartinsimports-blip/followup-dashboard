  ...
  return (
    <div className={darkMode?"dark":""} style={{ minHeight:"100vh", background:darkMode?"#0c1120":"#f1f5f9", color:darkMode?"#e2e8f0":"#0f172a", fontFamily:"'DM Sans',system-ui,sans-serif", transition:"background .2s,color .2s" }}>
      ...
      <main style={{ maxWidth: "100%", padding: "12px 20px" }}>
        ...
        {(tab === "listings" || tab === "orders") &&<div style={{ display:"flex", gap:6, alignItems:"center", marginBottom:12, flexWrap:"wrap" }}>
        ...
        {(tab === "listings" || tab === "orders") &&<div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 12, marginBottom: 24 }} className="fade-up">
          {[
            ...
            { label: "Impostos (mês)", value: fmt(totalImpostosMes), color: "#dc2626", desc: pctImpostos > 0 ? `${(pctImpostos*100).toFixed(2)}% (IRPJ+CSLL)` : "configure em ⚙️ Config", financeiro:true },
